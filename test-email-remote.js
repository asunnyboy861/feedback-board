...
async function testFeedbackSubmission() {
  const workerUrl = 'https://feedback-board.iocompile67692.workers.dev/api/feedback';
  ...
  try {
    ...
    if (response.ok && result.success) {
      ...
      console.log('5. 发件人域名 zzoutuo.com 是否已在 Resend 中验证');
    } else {
...
console.log('');
console.log('Worker URL:', 'https://feedback-board.iocompile67692.workers.dev');
console.log('');
console.log('提交测试反馈：');
